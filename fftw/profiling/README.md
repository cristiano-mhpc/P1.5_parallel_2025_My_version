...
- The last bit is output redirection (`>`) to a single file `subset_0_15.perf`. This file contains all samples from rank 0 -15 merged automatically   
...
- The combined stream gets written once to `subset_0_15.perf`.
