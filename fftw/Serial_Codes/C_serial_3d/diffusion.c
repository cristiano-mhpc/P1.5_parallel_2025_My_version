/*
 * This code calcutes the solution of the diffusion equaution in 3D, using time
 * forward discretization for the time derivative, and using discrete fourier
 * transform to calculate spatial derivatives.
 *
...
int main() {
  ...
  init_fftw(&fft_h1d, &fft_h2d, n1, n2, n3);
