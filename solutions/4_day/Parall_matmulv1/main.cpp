...
int main(int argc, char** argv){
	...
	*/
	...
	if (argc != 2){
		std::cout << "Enter the size of the square matrix from the command line. " << std::endl;
	...
	*/
	...
	for(size_t i = 0; i < comm_sz; i++){
		...
		*/
		...
		//we could also write a function to do matmul and return a packed result and then place the elemnts on the
		//appropriate non-contiguous elements of C_loc. 
